...
let im = document.querySelector("#baby-yoda-image")
...
let para = document.querySelector(".fun-fact")
...
let quot = document.querySelector("#qu")
...
let mah = document.getElementsByClassName("ma")
...
let paall = document.querySelectorAll("p")
